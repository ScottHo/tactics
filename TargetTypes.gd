...
static var ANY_OTHER = "Any Other Unit"
...
static var ALLIES_LIST: Array = [SELF, ALLIES, OTHER_ALLIES, ALL_ALLIES, ALL]
static var ENEMIES_LIST: Array = [ENEMIES, ALL_ENEMIES, ALL]
