...
and attack the target dummy"
    menuService.jenkins_talk(s, Jenkins.Mood.HAPPY)
    menuService.disableAllButtons(true)
    menuService.enable_attack_button(true)
    return
...
Now we can use our special ability! Let's see how you do."
    ...
    menuService.disableAllButtons(true)
    menuService.enable_moves_button(true)
    menuService.enable_special_button(true)
    return
...
\nLike moving, interact can be done as many times as you want."
    ...
    menuService.disableAllButtons(true)
    menuService.enable_moves_button(true)
    menuService.enable_interact_button(true)
    return
...
used once per mission."
    menuService.jenkins_talk(s, Jenkins.Mood.NORMAL)
    menuService.disableAllButtons(true)
    menuService.enable_ultimate_button(true)
    return

func end():
    var s = "Wow you are a skilled Coordinator. Maybe you will be the one to help us defeat the \
evil foundry overlords."
    menuService.jenkins_talk(s, Jenkins.Mood.HAPPY)
    menuService.disableAllButtons(true)
    return
