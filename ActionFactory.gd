...
static func add_base_attack(ent: Entity, _range: int):
    ...
    _add_test_action(ent, "Attack", d, _range, false, 0, [], base_effect, true, ActionType.ATTACK)
    return
...
static func add_sticky_grenade(ent: Entity, type: int):
    ...
    _add_test_action(ent, "Sticky Grenade", d, 3, false, 2, [], effect, true, type)
    return
...
static func add_refuel(ent: Entity, type: int):
    ...
    _add_test_action(ent, "Refuel", d, 0, true, 2, [], effect, true, type)
    return
...
static func add_storm(ent: Entity, type: int):
    ...
    _add_test_action(ent, "Storm", d, 4, true, 3, shape_3x3, effect, false, type)
    return
...
static func add_static_shield(ent: Entity, type: int):
    ...
    _add_test_action(ent, "Static Shield", d, 4, true, 3, shape_3x3, effect, true, type)
    return
...
static func add_focused_repair(ent: Entity, type: int):
    ...
    _add_test_action(ent, "Focused Repair", d, 4, true, 2, [], effect, true, type)
    return
...
static func add_nano_field(ent: Entity, type: int):
    ...
    _add_test_action(ent, "Nanofield", d, 4, true, 2, shape_3x3, effect, true, type)
    return
...
static func add_weapons_upgade(ent: Entity, type: int):
    ...
    _add_test_action(ent, "Weapons Upgrade", d, 1, false, 2, [], effect, true, type)
    return
...
static func add_engine_upgrade(ent: Entity, type: int):
    ...
    _add_test_action(ent, "Engine Upgrade", d, 1, false, 2, [], effect, true, type)
    return
...
static func add_snipe(ent: Entity, type: int):
    var effect = func (user: Entity, targets: Array):
        ...
        return
    var d = "Deals base damage to any target. Gains 1 Threat."
    _add_test_action(ent, "Snipe", d, 8, false, 1, [], effect, true, type)
    return
...
static func add_titanium_bullet(ent: Entity, type: int):
    ...
    _add_test_action(ent, "Titanium Bullet", d, 5, false, 5, [], effect, true, type)
    return

static func _add_test_action(ent, display_name, description, _range, self_castable, cost, shape, effect, offensive, action_type):
